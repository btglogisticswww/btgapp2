...
export default function Header({ title, toggleSidebar, toggleNotificationPanel }: HeaderProps) {
  ...
  return (
    <header className="bg-card border-b border-border h-16 flex items-center z-10 sticky top-0">
      <div className="flex-1 flex items-center justify-between px-4">
        <div className="flex items-center">
          <button 
            onClick={toggleSidebar}
            className="mr-4 md:hidden text-muted-foreground hover:text-foreground focus:outline-none"
